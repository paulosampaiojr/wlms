<?php
	...
	$turma_id = isset($_SESSION['aluno_turma']) != null ? $_SESSION['aluno_turma'] : '';
?>
			...
			<div class="row align-items-stretch no-gutters contact-wrap">
				<div class="col-md-12">
					<div class="form h-100">
					    ...
					    <?php
					        if ($filtrar_aluno) {
					            mostrar_total_de_horas_por_mes_e_aluno($conn, $mes, $aluno_id);
					        } else {
					            mostrar_total_de_horas_por_mes($conn, $mes, $turma_id);
					        }
					    ?>
					</div>
				</div>
