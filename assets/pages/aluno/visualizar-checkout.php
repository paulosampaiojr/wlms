                        ...
                        <div class="row align-items-stretch no-gutters contact-wrap">
                            <div class="col-md-12">
                                <div class="form h-100">
                                    <h3>CHECKOUT</h3>
                                    <form class="mb-5" method="post" id="" name="contactForm" action="validar-checkout.php">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group mb-3">
                                                <label for="budget" class="col-form-label">HORÁRIO DE SAÍDA</label>
                                                <?php
                                                    $Object = new DateTime(); 
                                                ...
                                                ?>
                                                <input type="text" class="form-control" name="lab_datasaida" id="lab_datasaida" readonly="true"  placeholder="" value='<?php echo $DateAndTime ?>'>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                <center> <input type="submit" value="FAZER CHECK-OUT" class="btn btn-primary rounded-0 py-2 px-4"> </center>
